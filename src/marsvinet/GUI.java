...
public class GUI extends javax.swing.JFrame {
    ...
    public GUI() {
        try {
            ...
            data_file.editMember(); // ændrer linje 3 (hardcoded i DAO_File
    ...
    private void jListMembersMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jListMembersMouseClicked
        ...
        Member_File member = data_file.getMember(id);
        
        jTextAreaMembers.append("Id: " + member.getId() + "\n");
        jTextAreaMembers.append("Name: " + member.getName() + "\n");
        jTextAreaMembers.append("Email: " + member.getEmail() + "\n");
        jTextAreaMembers.append("Birthday: " + member.getBirthday() + "\n");
        jTextAreaMembers.append("Active: " + member.isActive() + "\n");
        jTextAreaMembers.append("Elite: " + member.isElite() + "\n");
...
//        }
        ...
        for (Member_File member : data_file.getMembers()) {
            model.addElement(member.toString());
        }
